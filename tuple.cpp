...
int
main() {
    CSVReader<std::string, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int> reader("minutedata1");
    //reader.ignore_bad_row_length();
    reader.skip_first_lines();
    reader.read_rows();
